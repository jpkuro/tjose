...
$id =$_GET['admin_id'];
$sql= "select admin_id ,  name, email, estado, cedula, celular, lectivo from admin where $id=admin_id";
...
<div class="row">
<div class="col-lg-6">
<span class="logo">Editar datos: Administrador</span></div>
...
<center><h1>MODIFICAR DATOS ADMINISTRATIVOS</h1></center>
  ...
  <br>
    ...
    <br>
    <br>
    <b>MODIFIQUE EL AÑO LECTIVO ESTADO</b>
    <div>
      <?php $lectivo2 ="select id_lectivo, lectivo from lectivo where estado='activo'";
$resultadomad =$con->query($lectivo2);  
?>
<br>
     <select name="lectivo" style="color: #a2a2a2; font-weight: bold; padding: 10px; width:500px; border: 2px solid #d8d8d8; border-radius: 6px;"required>
                ...
                <?php WHILE ($row = $resultadomad->fetch_assoc()){?>
