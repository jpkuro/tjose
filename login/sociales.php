...
if($curso==ter003 and $materia==sociales){
			echo "<script>location.href='../sesion/estudiante/Juego_Memoria/index.php'</script>";
		
		}elseif($curso==cu004 and $materia==sociales){
			echo "<script>location.href='Juego_Memoria2/index.php'</script>";
		
		}elseif($curso==qu005 and $materia==sociales){
			echo "<script>location.href='Juego_Memoria3/index.php'</script>";
		}elseif($curso==sex006 and $materia==sociales){
				echo "<script>location.href='Juego_Memoria3/index.php'</script>";
		}else{
