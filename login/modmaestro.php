...
$id =$_GET['id'];
$sql= "select maestro.id, maestro.cedula, maestro.nombre, maestro.apellido, maestro.curso, maestro.email, maestro.celular,  rol,  maestro.lectivo, estado, curso.id_curso,curso.curso,semestre.id_semestre,semestre.semestre, parcial.id_parcial, parcial.parcial , maestro.id_materia, materia.id_materia from maestro inner join curso inner join semestre inner join parcial inner join materia on maestro.curso=curso.id_curso and maestro.id_semestre=semestre.id_semestre and maestro.id_parcial=parcial.id_parcial and maestro.id_materia=materia.id_materia where $id=maestro.id";
...
<div class="row">
<div class="col-lg-6">
<span class="logo">Editar datos: Maestro</span></div>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class="pull-right"> <a href="dash.php?q=8"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Regresar</a></li>
...
<center><h1>MODIFICAR DATOS DEL MAESTRO</h1></center>
 
  <center>
  <form method="post" action="editarma.php">
  ...
  <br>
    <input type="text" name="namea" placeholder="Ingrese el nombre" value="<?php echo $row['nombre']; ?>" style="color: #a2a2a2; font-weight: bold; padding: 10px;width:500px; border: 2px solid #d8d8d8; border-radius: 6px;" required>
    <br>
    <br>
    <b> MODIFIQUE APELLIDO</b>
  
  <br>
    <input type="text" name="apellido" placeholder="Ingrese el apellido" value="<?php echo $row['apellido']; ?>"style="color: #a2a2a2; font-weight: bold; padding: 10px; width:500px; border: 2px solid #d8d8d8; border-radius: 6px;" required>
    <br>
...
?>
  ...
  <b> Materia</b>
  <br>
  <?php $materia ="select id_materia, materia from materia ";
$resultadomate =$con->query($materia);  
?>
     <select name="materia" style="color: #a2a2a2; font-weight: bold; padding: 10px; width:500px; border: 2px solid #d8d8d8; border-radius: 6px;"required>
                ...
                <?php WHILE ($row = $resultadomate->fetch_assoc()){?>
