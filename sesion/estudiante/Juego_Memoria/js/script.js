...
new Vue({
    ...
    methods: {
        mostrarCreditos() {
            Swal.fire({
                title: "Acerca de",
                html: `El siguiente juego es realizado por memoria Referente a presidentes del ecuador
                <br>
        ...
        indicarVictoria() {
            Swal.fire({
                ...
                <p class="h4">Muy bien hecho</p>`,
                    confirmButtonText: "Siguiente juego ",
                    allowOutsideClick: false,
                    allowEscapeKey: false,
                })
                .then(this.redireccion)
                
        },
        
        redireccion(){
            location.href='../Juegopuzzle/index.html';
       ...
       // guardarjuego() {
         //   private $gano;
           ...
           // if (this.indicarVictoria()===true){
            //    require("../conexion.php");
            //    $ganar ="INSERT INTO ganados (id,usuario,apellido,clave,correo,rol,curso) VALUES ('','$nombre','$apellido','$clave','$correo'//,'$rol','$curso')";
